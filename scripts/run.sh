...
if [ ! -f "$DATA_DIR"/postgresql.conf ]; then
    ...
    sudo -i -u postgres /usr/lib/postgresql/9.6/bin/initdb -E utf8 --locale en_US.UTF-8 -D "$DATA_DIR"
...
exec chpst sudo -i -u postgres /usr/lib/postgresql/9.6/bin/postgres -D "$DATA_DIR"
